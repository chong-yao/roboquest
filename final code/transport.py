...
def correctLeft():
    global doDetect, lineFollowThreshold, vehicleCommand, containerFilled, vehicleLocation, correctionSpeed, my_180deg, my_90deg, movementSpeed, junctionCount, currentPath, doTravel, doWait, servoP1DownAngle, servoP1UpAngle, servoP0DownAngle, servoP0UnloadAngle, imageDetection, i, count, _imageDetection_x, _imageDetection_y, SETVFLIP, SETHMIRROT, ScreenOrientation, _PWN_gpio_1, _PWN_gpio_2
    C.speedControl(-(movementSpeed * 0.8))
    D.speedControl(-(movementSpeed * 0.8))
    E.speedControl(-(movementSpeed * 0.25))
    F.speedControl(-(movementSpeed * 0.25))

def correctRight():
    global doDetect, lineFollowThreshold, vehicleCommand, containerFilled, vehicleLocation, correctionSpeed, my_180deg, my_90deg, movementSpeed, junctionCount, currentPath, doTravel, doWait, servoP1DownAngle, servoP1UpAngle, servoP0DownAngle, servoP0UnloadAngle, imageDetection, i, count, _imageDetection_x, _imageDetection_y, SETVFLIP, SETHMIRROT, ScreenOrientation, _PWN_gpio_1, _PWN_gpio_2
    C.speedControl(-(movementSpeed * 0.25))
    D.speedControl(-(movementSpeed * 0.25))
    E.speedControl(-(movementSpeed * 0.8))
    F.speedControl(-(movementSpeed * 0.8))

def turnLeft():
    global doDetect, lineFollowThreshold, vehicleCommand, containerFilled, vehicleLocation, correctionSpeed, my_180deg, my_90deg, movementSpeed, junctionCount, currentPath, doTravel, doWait, servoP1DownAngle, servoP1UpAngle, servoP0DownAngle, servoP0UnloadAngle, imageDetection, i, count, _imageDetection_x, _imageDetection_y, SETVFLIP, SETHMIRROT, ScreenOrientation, _PWN_gpio_1, _PWN_gpio_2
    C.speedControl(-(movementSpeed * 0.72))
    D.speedControl(-(movementSpeed * 0.72))
    E.speedControl((movementSpeed * 0.72))
    F.speedControl((movementSpeed * 0.72))
